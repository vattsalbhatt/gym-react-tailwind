...
function TrainerBox() {
  ...
  const trainers = [
    { img: Trainer1, name: "Vidyut Jamwal", job: "Yoga Trainer" },
    { img: Trainer2, name: "Tiger Shroff", job: "Crossfit Trainer" },
    { img: Trainer3, name: "Krishna Shroff", job: "Personal Trainer" },
  ];
