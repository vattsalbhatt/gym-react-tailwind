      ...
      <section id="pricing" className="pricing-section relative">
        <div className="container page-padding py-[12rem] ">
          ...
          <div className="flex gap-10 mt-32 relative z-[2] md1000:flex-col md1000:items-center ">
            <PricingBox img={Img1} price="3,900" planType={"Beginners"} />
            <PricingBox img={Img2} price="6,500" planType={"Intermediate"} />
            <PricingBox img={Img3} price="10,000" planType={"Advanced"} />
          </div>
          <img
            src={BgDumbell}
            alt="bg_icon"
